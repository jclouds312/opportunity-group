      ...
      <div className="mt-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Un resumen de las actividades recientes en la plataforma.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">El gráfico de actividad y la tabla de transacciones recientes se mostrarán aquí.</p>
          </CardContent>
        </Card>
      </div>
    </div>
